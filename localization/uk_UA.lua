...
local uk = {
        ...
        Joker = {
            j_8_ball = {
                ...
                text = {
                    ...
                    "зіграну та зараховану карту {C:attention}8{} створити",
                    "карту {C:tarot}Таро{}",
            ...
            j_business = {
                ...
                text = {
                    ...
                    "мають {C:green}#1# з #2#{} ймовірність",
                    "дати {C:money}₴2{}",
                },
            },
            j_caino = {
            ...
            j_drivers_license = {
                ...
                unlock = {
                    "Покращіть {E:1,C:attention}#1#{} карт",
                    "у вашій колоді",
                },
            },
            j_droll = {
    ...
    misc = {
        achievement_descriptions = {
            ...
            astronomy = "Відкрийте кожну карту Планет",
        ...
        dictionary = {
            ...
            ml_controller_required = {
                "Для гри потрібен ігровий контроллер.",
                "Будь ласка, під'єднайте контроллер для продовження'.",
            },
            ...
            ml_offline_message = {
                "Цей пристрій офлайн.",
                "Дане збереження може бути застарілим.",
            },
            ml_open_target = {
                "Відкрити",
            },
            ...
            ph_click_confirm = "Оберіть знову, щоб підтвердити",
        ...
        quips = {
            dq_1 = {
                "Ой! Я сподіваюсь",
                "в тебе лишилось кілька",
                "фокусів в рукаві",
                "для фінального виклику!",
            },
            lq_1 = {
                "Можливо нам",
                "варто грати в",
            ...
            lq_4 = {
                "Знаєш,",
                "кажуть",
                "казино завжди перемагає!",
            },
            lq_5 = {
                "Схоже ми",
                "дізнались",
                "хто тут справжній Джокер!",
            },
            lq_6 = {
                "О ні, ти",
                "теж блефував?",
        ...
        tutorial = {
            ...
            fh_4_touch = {
                "Карти також дають",
                "певну кількість {C:blue}фішок{},",
                "натисніть та утримуйте для перегляду!",
            },
            fh_5 = {
            ...
            fh_5_touch = {
                "Тепер натисніть на до {C:attention}5{} карт,",
                "щоб сформувати покерну руку",
                "та натисніть {C:blue}'Зіграти руку'",
            },
            fh_6 = {
            ...
            s_2_touch = {
                "Спробуйте купити цього",
                "красунчика Диявола",
                "Перетягніть його з магазину",
                "в зону {C:attention}'КУПИТИ'{}",
            },
            s_3 = {
                "Це один з {C:attention}#1#",
                "{C:attention}Джокерів{}, яких можна додати",
                "у ваш забіг. Кожен {C:attention}Джокер",
                "робить різні речі",
            },
            s_4 = {
                "Цей додає {C:red}+4 множ.{} до",
            ...
            sh_3_touch = {
                "Оберіть до {C:attention}2{} карт",
                "в вашій руці та перетягніть",
                "карти {C:tarot}Таро{} в  зону {C:attention}'ВИКОРИСТАТИ'{}",
                "для того щоб покращити карти!"
            },
        },
        v_dictionary = {
